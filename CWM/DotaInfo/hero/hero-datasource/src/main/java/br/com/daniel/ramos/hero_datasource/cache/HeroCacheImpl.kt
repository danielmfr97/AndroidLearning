...
import br.com.daniel.ramos.herodatasource.cache.HeroDbQueries

class HeroCacheImpl(
    private val heroDatabase: HeroDatabase, /**Object that contains all the queries pointed out on sqldelight */
): HeroCache {
